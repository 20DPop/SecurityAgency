...
export default function PontarePage() {
  ...
  const [isModalOpen, setIsModalOpen] = useState(false); // <-- LINIA CORECTĂ ESTE AICI
    ...
    <div className="pontare-page">
      ...
      <div className="pontare-container">
        ...
        <div className="pontaj-info">
          {activePontaj 
            ? <p><b>Tură activă începută la:</b> {new Date(activePontaj.ora_intrare).toLocaleString()}</p>
