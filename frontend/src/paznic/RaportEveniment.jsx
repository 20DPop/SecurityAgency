// Cale: frontend/src/paznic/RaportEveniment.jsx

import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import axios from 'axios';
import './RaportEveniment.css';
// Importăm componenta de semnătură
...
export default function RaportEveniment() {
  ...
  const [formData, setFormData] = useState({
    ...
    descriereFapta: '',
    cazSesizatLa: '',
    // Adăugăm câmpul pentru semnătură
    signatureDataURL: '', 
  });
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState('');
  // Adăugăm starea pentru a bloca formularul după semnare
  ...
  // Funcție pentru a salva semnătura
  ...
  return (
    <div className="form-page-container">
      <form onSubmit={handleSubmit} className="form-card">
        ...
        {/* Dezactivăm formularele după semnare */}
        <fieldset disabled={signatureSaved}>
            {/* ... (toate div-urile cu `form-grid` și `form-group` rămân aici) ... */}
        ...
        {/* Adăugăm secțiunea de semnătură */}
        <fieldset>
